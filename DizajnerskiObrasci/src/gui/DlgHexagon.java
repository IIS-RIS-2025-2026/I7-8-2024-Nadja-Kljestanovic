...
public class DlgHexagon extends JDialog {
	...
	private void initGui() {
		...
		gbl_contentPanel.columnWidths = new int[] { 0, 0, 0, 0, 1, 0 };
	...
	private void addInputFields() {
		...
		txtX = new JTextField();
		addComponent(txtX, 4, 1);

		addLabel("Y coordinate:", 2);
		txtY = new JTextField();
		addComponent(txtY, 4, 2);

		addLabel("Radius (R):", 3);
		txtR = new JTextField();
		addComponent(txtR, 4, 3);
	}
	...
	private void processHexagonData() {
	...
	private void addComponent(javax.swing.JComponent comp, int x, int y) {
	...
	private void addBtnComponent(javax.swing.JComponent comp, int x, int y) {
		GridBagConstraints gbc = new GridBagConstraints();
	...
	private boolean isAnyFieldEmpty() {
		return txtX.getText().isEmpty() || txtY.getText().isEmpty() || txtR.getText().isEmpty();
	}

	private boolean areFieldsNumeric() {
		return isNumeric(txtX.getText()) && isNumeric(txtY.getText()) && isNumeric(txtR.getText());
	}
